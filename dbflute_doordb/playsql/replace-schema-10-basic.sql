...
(
	...
	MIN INT COMMENT '最小値 : ドアが閉まっていると判断する最小値',
	MAX INT COMMENT '最大値 : ドアが閉まっていると判断する最大値',
	PRIMARY KEY (DOOR_ID)
) COMMENT = 'ドア';
...
(
	...
	SENSOR_DISTATNCE INT NOT NULL COMMENT 'センサー距離 : ドアとセンサーとの距離。センサーの位置によって空いている、閉まっているの判断基準が変わる。距離だけでは、判断できない。',
...
CREATE INDEX INDEX_DOOR_ID_REGISTER_DATETIME ON DOOR_SENSOR_LOG (REGISTER_DATETIME ASC);
