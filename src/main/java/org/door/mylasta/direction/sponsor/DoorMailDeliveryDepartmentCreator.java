 ...
 * @author jflute
 */
public class DoorMailDeliveryDepartmentCreator {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public DoorMailDeliveryDepartmentCreator(DoorConfig doorConfig) {
    ...
    protected SMailPostalParkingLot createPostalParkingLot() {
        ...
        final String hostAndPort = doorConfig.getMailSmtpServerMainHostAndPort();
        ...
        motorbike.registerReturnPath(doorConfig.getMailReturnPath());
    ...
    protected SMailPostalPersonnel createPostalPersonnel() {
        ...
        return doorConfig.isMailSendMock() ? personnel.asTraining() : personnel;
    }

    protected SMailDogmaticPostalPersonnel createDogmaticPostalPersonnel() { // #ext_point e.g. locale, database
        final String testPrefix = doorConfig.getMailSubjectTestPrefix();
