 ...
 * @author jflute
 */
public class DoorTimeResourceProvider extends TypicalTimeResourceProvider {
    ...
    //                                                                         Constructor
    //                                                                         ===========
    public DoorTimeResourceProvider(DoorConfig doorConfig) {
    ...
    protected TimeZone getCentralTimeZone() {
        return DoorUserTimeZoneProcessProvider.centralTimeZone;
    }
    ...
    protected String getTimeAdjustTimeMillis() {
        return doorConfig.getTimeAdjustTimeMillis();
    }

    @Override
    protected Long getTimeAdjustTimeMillisAsLong() {
        return doorConfig.getTimeAdjustTimeMillisAsLong();
    }
}
