 ...
 * @author jflute
 */
public class DoorSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public DoorSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
