...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchaseId = cci("PURCHASE_ID", "PURCHASE_ID", null, null, Long.class, "purchaseId", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_BF90322D_4A18_40DE_A02D_16C41955B430", false, null, null, null, "purchasePaymentList", null, false);
    ...
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, "商品ID", Integer.class, "productId", null, false, false, true, "INTEGER", 10, 0, null, false, null, null, "product", null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.door.dbflute.exentity.Purchase"; }
    public String getConditionBeanTypeName() { return "org.door.dbflute.cbean.PurchaseCB"; }
    public String getBehaviorTypeName() { return "org.door.dbflute.exbhv.PurchaseBhv"; }
