...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberAddressId = cci("MEMBER_ADDRESS_ID", "MEMBER_ADDRESS_ID", null, "会員住所ID", Integer.class, "memberAddressId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_545178F8_DD57_47E7_90A6_7B5038F2C134", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.door.dbflute.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "org.door.dbflute.cbean.MemberAddressCB"; }
    public String getBehaviorTypeName() { return "org.door.dbflute.exbhv.MemberAddressBhv"; }
