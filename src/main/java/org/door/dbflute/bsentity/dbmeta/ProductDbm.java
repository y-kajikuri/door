...
public class ProductDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, null, Integer.class, "productId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_FCEEC00E_C933_4BAB_A16B_8B54DEBF8D08", false, null, null, null, "purchaseList", null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.door.dbflute.exentity.Product"; }
    public String getConditionBeanTypeName() { return "org.door.dbflute.cbean.ProductCB"; }
    public String getBehaviorTypeName() { return "org.door.dbflute.exbhv.ProductBhv"; }
