...
public class MemberFollowingDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberFollowingId = cci("MEMBER_FOLLOWING_ID", "MEMBER_FOLLOWING_ID", null, "会員フォローイングID", Long.class, "memberFollowingId", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_E4E6F821_12EB_4ADF_A817_39F519B0FD19", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.door.dbflute.exentity.MemberFollowing"; }
    public String getConditionBeanTypeName() { return "org.door.dbflute.cbean.MemberFollowingCB"; }
    public String getBehaviorTypeName() { return "org.door.dbflute.exbhv.MemberFollowingBhv"; }
