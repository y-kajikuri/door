...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberServiceId = cci("MEMBER_SERVICE_ID", "MEMBER_SERVICE_ID", null, "会員サービスID", Integer.class, "memberServiceId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_D5E8C71F_B7E6_4415_90BF_7F53B062964E", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.door.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "org.door.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "org.door.dbflute.exbhv.MemberServiceBhv"; }
