...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnRegionId = cci("REGION_ID", "REGION_ID", null, "地域ID", Integer.class, "regionId", null, true, false, true, "INTEGER", 10, 0, null, false, null, null, null, "memberAddressList", CDef.DefMeta.Region, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.door.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "org.door.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "org.door.dbflute.exbhv.RegionBhv"; }
