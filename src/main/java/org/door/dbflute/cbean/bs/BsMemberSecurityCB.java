...
public class BsMemberSecurityCB extends AbstractConditionBean {
    ...
    public MemberSecurityCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected MemberSecurityCQ doGetConditionQuery() {
     ...
     */
    public void union(UnionQuery<MemberSecurityCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<MemberSecurityCB> unionCBLambda) {
        final MemberSecurityCB cb = new MemberSecurityCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">memberSecurity</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">memberSecurity</span>.<span style="color: #CC4747">getMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberSecurityCQ> {
        ...
        public HpSDRFunction<MemberSecurityCB, MemberSecurityCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MemberSecurityCB> sq, MemberSecurityCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public void orScopeQuery(OrQuery<MemberSecurityCB> orCBLambda) {
        xorSQ((MemberSecurityCB)this, orCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return MemberSecurityCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return MemberSecurityCQ.class.getName(); }
