 ...
 */
public class BsDoorCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected DoorCQ _conditionQuery;
    ...
    public DoorCB acceptPK(Integer doorId) {
        ...
        BsDoorCB cb = this;
        cb.query().setDoorId_Equal(doorId);
        return (DoorCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_DoorId_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_DoorId_Desc();
        return this;
    }
    ...
    public DoorCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected DoorCQ doGetConditionQuery() {
    ...
    protected DoorCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected DoorCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        DoorCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected DoorCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new DoorCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<DoorCB> unionCBLambda) {
        final DoorCB cb = new DoorCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final DoorCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<DoorCB> unionCBLambda) {
        final DoorCB cb = new DoorCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final DoorCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<DoorCQ> {
         ...
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnDoorName() { return doColumn("DOOR_NAME"); }
        /**
         * (最小値)MIN: {NotNull, INT(10)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMin() { return doColumn("MIN"); }
        /**
         * (最大値)MAX: {NotNull, INT(10)}
         * @return The information object of specified column. (NotNull)
         */
        public SpecifiedColumn columnMax() { return doColumn("MAX"); }
         ...
         * }, DoorSensorLog.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<DoorSensorLogCB, DoorCQ> derivedDoorSensorLog() {
            assertDerived("doorSensorLogList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<DoorSensorLogCB> sq, DoorCQ cq, String al, DerivedReferrerOption op)
                    -> cq.xsderiveDoorSensorLogList(fn, sq, al, op), _dbmetaProvider);
        }
        /**
         * Prepare for (Specify)MyselfDerived (SubQuery).
         * @return The object to set up a function for myself table. (NotNull)
         */
        public HpSDRFunction<DoorCB, DoorCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<DoorCB> sq, DoorCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public DoorCB dreamCruiseCB() {
        DoorCB cb = new DoorCB();
        cb.xsetupForDreamCruise((DoorCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<DoorCB> columnQuery(final SpecifyQuery<DoorCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected DoorCB xcreateColumnQueryCB() {
        DoorCB cb = new DoorCB();
        cb.xsetupForColumnQuery((DoorCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<DoorCB> orCBLambda) {
        xorSQ((DoorCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<DoorCB> andCBLambda) {
        xorSQAP((DoorCB)this, andCBLambda);
    }
    ...
    protected String xgetConditionBeanClassNameInternally() { return DoorCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return DoorCQ.class.getName(); }
