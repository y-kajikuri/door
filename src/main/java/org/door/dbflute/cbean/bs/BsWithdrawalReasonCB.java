...
public class BsWithdrawalReasonCB extends AbstractConditionBean {
    ...
    protected WithdrawalReasonCQ createLocalCQ() {
     ...
     */
    public void union(UnionQuery<WithdrawalReasonCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<WithdrawalReasonCB> unionCBLambda) {
        final WithdrawalReasonCB cb = new WithdrawalReasonCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<WithdrawalReasonCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<WithdrawalReasonCQ> qyCall
         ...
         *     withdrawalCB.query().set... <span style="color: #3F7E5E">// referrer condition</span>
         * }, MemberWithdrawal.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
     ...
     */
    public void orScopeQuery(OrQuery<WithdrawalReasonCB> orCBLambda) {
        xorSQ((WithdrawalReasonCB)this, orCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final WithdrawalReasonCB cb;
        if (mainCB != null) {
            cb = (WithdrawalReasonCB)mainCB;
        } else {
