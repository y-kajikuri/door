...
public class BsMemberServiceCB extends AbstractConditionBean {
     ...
     */
    public void unionAll(UnionQuery<MemberServiceCB> unionCBLambda) {
        final MemberServiceCB cb = new MemberServiceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     *     ... = <span style="color: #553000">memberService</span>.<span style="color: #CC4747">getMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberServiceCQ> {
        ...
        public ServiceRankCB.HpSpecification specifyServiceRank() {
            ...
            if (_serviceRank == null) {
                _serviceRank = new ServiceRankCB.HpSpecification(_baseCB
        ...
        public HpSDRFunction<MemberServiceCB, MemberServiceCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MemberServiceCB> sq, MemberServiceCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public void orScopeQuery(OrQuery<MemberServiceCB> orCBLambda) {
        xorSQ((MemberServiceCB)this, orCBLambda);
    }
