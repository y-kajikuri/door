...
public class BsMemberAddressCB extends AbstractConditionBean {
     ...
     */
    public void union(UnionQuery<MemberAddressCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<MemberAddressCB> unionCBLambda) {
        final MemberAddressCB cb = new MemberAddressCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     *     ... = <span style="color: #553000">memberAddress</span>.<span style="color: #CC4747">getMember()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<MemberAddressCQ> {
        ...
        public HpSDRFunction<MemberAddressCB, MemberAddressCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MemberAddressCB> sq, MemberAddressCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public void orScopeQuery(OrQuery<MemberAddressCB> orCBLambda) {
