...
public class BsRegionCB extends AbstractConditionBean {
    ...
    //                                                                           Attribute
    //                                                                           =========
    protected RegionCQ _conditionQuery;
    ...
    protected RegionCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected RegionCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        RegionCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected RegionCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     */
    public void union(UnionQuery<RegionCB> unionCBLambda) {
     ...
     */
    public void unionAll(UnionQuery<RegionCB> unionCBLambda) {
        final RegionCB cb = new RegionCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
    ...
    public static class HpSpecification extends HpAbstractSpecification<RegionCQ> {
        ...
        public HpSDRFunction<MemberAddressCB, RegionCQ> derivedMemberAddress() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<MemberAddressCB> sq, RegionCQ cq, String al, DerivedReferrerOption op)
        ...
        public HpSDRFunction<RegionCB, RegionCQ> myselfDerived() {
            ...
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<RegionCB> sq, RegionCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public void orScopeQuery(OrQuery<RegionCB> orCBLambda) {
        xorSQ((RegionCB)this, orCBLambda);
    }
