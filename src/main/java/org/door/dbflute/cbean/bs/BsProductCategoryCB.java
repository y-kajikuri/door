...
public class BsProductCategoryCB extends AbstractConditionBean {
     ...
     */
    public void unionAll(UnionQuery<ProductCategoryCB> unionCBLambda) {
        final ProductCategoryCB cb = new ProductCategoryCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
     ...
     * }).alwaysPresent(<span style="color: #553000">productCategory</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     ... = <span style="color: #553000">productCategory</span>.<span style="color: #CC4747">getProductCategorySelf()</span>; <span style="color: #3F7E5E">// you can get by using SetupSelect</span>
     * });
     * </pre>
    ...
    public static class HpSpecification extends HpAbstractSpecification<ProductCategoryCQ> {
         ...
         * }, ProductCategory.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
     ...
     */
    public void orScopeQuery(OrQuery<ProductCategoryCB> orCBLambda) {
