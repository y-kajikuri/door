...
import org.door.dbflute.cbean.cq.bs.BsDoorCQ;

/**
 * The condition-query of DOOR.
 * <p>
 ...
 */
public class DoorCQ extends BsDoorCQ {
     ...
     */
    public DoorCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
