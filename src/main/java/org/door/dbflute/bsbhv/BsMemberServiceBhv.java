...
public abstract class BsMemberServiceBhv extends AbstractBehaviorWritable<MemberService, MemberServiceCB> {
    ...
    protected OptionalEntity<MemberService> facadeSelectEntity(MemberServiceCB cb) {
     ...
     * <pre>
     * MemberService <span style="color: #553000">memberService</span> = <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * <pre>
     * ListResultBean&lt;MemberService&gt; <span style="color: #553000">memberServiceList</span> = <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (MemberService <span style="color: #553000">memberService</span> : <span style="color: #553000">memberServiceList</span>) {
     *     ... = <span style="color: #553000">memberService</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of MemberService. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;MemberService&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (MemberService memberService : <span style="color: #553000">page</span>) {
     *     ... = memberService.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of MemberService. (NotNull)
     ...
     */
    public <RESULT> HpSLSFunction<MemberServiceCB, RESULT> selectScalar(Class<RESULT> resultType) {
     ...
     * <pre>
     * MemberService memberService = <span style="color: #70226C">new</span> MemberService();
     ...
     * <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">insert</span>(memberService);
     ...
     *     <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">delete</span>(memberService);
     ...
     * }
     * <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">batchInsert</span>(memberServiceList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;MemberService, MemberServiceCB&gt;() {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//memberService.setVersionNo(value);</span>
     * <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">queryUpdate</span>(memberService, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * memberService.setFoo...(value);
     * memberService.setBar...(value);
     * <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">varyingInsert</span>(memberService, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">varyingUpdate</span>(memberService, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//memberService.setVersionNo(value);</span>
     * <span style="color: #0000C0">memberServiceBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(memberService, <span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().setFoo...
