...
public abstract class BsMemberSecurityBhv extends AbstractBehaviorWritable<MemberSecurity, MemberSecurityCB> {
     ...
     * <pre>
     * MemberSecurity <span style="color: #553000">memberSecurity</span> = <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">selectEntityWithDeletedCheck</span>(cb <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> cb.acceptPK(1));
     ...
     * <pre>
     * ListResultBean&lt;MemberSecurity&gt; <span style="color: #553000">memberSecurityList</span> = <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">selectList</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...;
     *     <span style="color: #553000">cb</span>.query().addOrderBy...;
     * });
     * <span style="color: #70226C">for</span> (MemberSecurity <span style="color: #553000">memberSecurity</span> : <span style="color: #553000">memberSecurityList</span>) {
     *     ... = <span style="color: #553000">memberSecurity</span>.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of MemberSecurity. (NotNull)
     ...
     * <pre>
     * PagingResultBean&lt;MemberSecurity&gt; <span style="color: #553000">page</span> = <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">selectPage</span>(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">cb</span>.query().set...
     *     <span style="color: #553000">cb</span>.query().addOrderBy...
     ...
     * ...
     * <span style="color: #70226C">for</span> (MemberSecurity memberSecurity : <span style="color: #553000">page</span>) {
     *     ... = memberSecurity.get...;
     * }
     * </pre>
     * @param cbLambda The callback for condition-bean of MemberSecurity. (NotNull)
     ...
     * <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">insert</span>(memberSecurity);
     ...
     *     <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">delete</span>(memberSecurity);
     ...
     * }
     * <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">batchInsert</span>(memberSecurityList);
     * </pre>
     ...
     *     memberSecurityList.add(memberSecurity);
     * }
     * <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">batchUpdate</span>(memberSecurityList);
     * </pre>
     ...
     * <pre>
     * <span style="color: #0000C0">memberSecurityBhv</span>.<span style="color: #CC4747">queryInsert</span>(new QueryInsertSetupper&lt;MemberSecurity, MemberSecurityCB&gt;() {
