 ...
 */
package org.door.app.logic.context;
...
public class AccessContextLogic {
    ...
    public AccessContext create(AccessContextResource resource, UserTypeSupplier userTypeSupplier, AppTypeSupplier appTypeSupplier) {
